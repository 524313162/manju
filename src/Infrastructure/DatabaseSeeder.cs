...
- duration: 持续时间",
    ...
    private static async Task SeedApiProvidersAsync(ProjectDbContext db)
    {
        ...
        var toAdd = new List<ApiProvider>
        {
            ...
            new() { Name = "ComfyUI (Local) - QWen图生图", Capability = AiCapability.ImageToImageQwen, Type = ProviderType.ComfyUI, ApiUrl = "http://localhost:8188", ApiKey = "", Model = "07.QWen-图生图2.json", CreatedTime = now, UpdatedTime = now },
        };
