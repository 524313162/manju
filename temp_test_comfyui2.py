...
# Test with steps=0 (what ConvertUiWorkflowToApiJson would generate)
prompt = {
    ...
    '74': {'class_type': 'KSampler', 'inputs': {'model': ['73', 0], 'positive': ['203', 0], 'negative': ['201', 0], 'latent_image': ['72', 0], 'seed': 0, 'steps': 0, 'cfg': 1, 'sampler_name': 'res_multistep', 'scheduler': 'simple', 'denoise': 1}},
